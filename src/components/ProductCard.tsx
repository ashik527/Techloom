...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  const handleWhatsApp = (e: React.MouseEvent) => {
    e.stopPropagation();
    e.preventDefault();
    const message = `Hello PlaxoMart! I am interested in ${product.title} (Price: ${formatPrice(product.salePrice)}). Can you help me?`;
        ...
        <div className="p-5">
          ...
          <div className="flex items-center justify-between mb-5">
            <div className="flex flex-col">
              <span className="text-lg font-black text-indigo-600">{formatPrice(product.salePrice)}</span>
